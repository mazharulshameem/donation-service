...
import edu from "./../../../assets/img/tubewell.jpg";

const BuildAWaterWell = () => {
  ...
  return (
    <section>
      <div className="card m-3 w-75 mx-auto">
        <img src={edu} className="  img-fluid img" alt="..." />
        <div className="card-body">
          <h5 className="card-title">Support for Build A TubeWell </h5>
...
export default BuildAWaterWell;
